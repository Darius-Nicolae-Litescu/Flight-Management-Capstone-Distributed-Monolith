...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = {SeatCapacityExceededException.class})
    public ResponseEntity<Object> seatCapacityExceededException(SeatCapacityExceededException seatCapacityExceededException, WebRequest webRequest) {
        logger.error("Seat capacity exceeded: ", seatCapacityExceededException.getMessage());
        Function<String, String> seatCapacityExceeded =
                (message) -> message;

        APIError apiError = initializeAPIError(seatCapacityExceededException, seatCapacityExceeded, webRequest);
